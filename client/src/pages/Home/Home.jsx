                          ...
                          return (
                            <div className='col-md-12' key={index}>
                              <div className='preview'>
                                <img src={imgURL} alt='' />
                                <button onClick={() => handleImgCloseBtn(item)}>X</button>
                              </div>
                            </div>
                          );
                        })}
                      </div>
                      <button onClick={handleNextBtn} className='btn btn-primary btn-sm w-100 nextBtn'>
                        next
                      </button>
                    </div>
                  ) : (
                    ...
                    <div className='story-area'>
                      <div className='content'>
                        <div className='row'>
                          ...
                          <div className='story-box'>
                            <img src='https://energaia.com/wp-content/uploads/2020/10/team-member-8.jpg' alt='' />
                            <p>rakib</p>
                          </div>
                          <div className='story-box'>
                            <img
                      ...
                      <>
                        {adminData.reverse().map((item, index) => (
                          <div className='post-area' key={index}>
                            ...
                            <img className='post-img' src={item.post_img} alt='' />
                            ...
                            <div className='post-caption-info'>
                              <p>600 likes</p>
                              <p>
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorum modi dolores cum
